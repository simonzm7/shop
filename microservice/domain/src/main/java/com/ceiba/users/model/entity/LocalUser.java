...
public class LocalUser {
    ...
    public LocalUser(
        ...
        InputValidation.notNull(countryId, CommonVariables.buildEmptyErrorMessage("national identification"));
        InputValidation.notNull(password, CommonVariables.buildEmptyErrorMessage("password"));
        InputValidation.notNull(name, CommonVariables.buildEmptyErrorMessage("name"));
        InputValidation.notNull(email, CommonVariables.buildEmptyErrorMessage("email"));
